...
describe ('Test suite: renderOrderSummary', () => {
    ...
    it('Displays the cart', () => {
        ...
        //to contain chekea si x valor contiene ('este valor')
...
*/
    ...
    it('Removes a product', () => {
        ...
        console.log("antes de eliminar:" + cart.length );
        //me traigo el delete link y lo clickeo
        document.querySelector(`.js-delete-link-${productId1}`).click();
        /*
        Aca no funcionaria orque en el codigo de order summary cuando elimino un producto tambien estoy llamando a renderizar la orden. y como esa orden Payment no la tengo aca me tira null y tambien debo traer el div para que lo renderice
        */
        console.log("despues de eliminar" + cart.length);
